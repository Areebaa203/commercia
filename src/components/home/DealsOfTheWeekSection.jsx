...
function DealProductCard({ product }) {
  return (
    <article className="flex h-full min-h-0 flex-col items-center rounded-[6px] border border-[#e4dfd4] p-3 text-center shadow-sm sm:p-4" style={{ backgroundColor: CARD_BG }}>
      ...
      <button
        type="button"
        className="font-home-sub mt-auto w-full border border-[#cfccc3] bg-[#f7f3ec] py-2 text-[9px] font-semibold uppercase tracking-[0.14em] text-[#1a1a1a] transition hover:bg-[#2A3E34] hover:text-white sm:py-2.5 sm:text-[10px]"
