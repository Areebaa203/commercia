      ...
      >
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-1.5">
                ...
                <select className="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-900 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all">
                    <option>Select a product...</option>
                    <option>Hybrid Active Noise Cancelling</option>
                    <option>Casio G-Shock</option>
