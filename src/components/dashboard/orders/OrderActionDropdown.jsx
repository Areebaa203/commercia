...
const OrderActionDropdown = ({ isOpen, onClose, anchorRef, order, onView, onEdit, onDelete }) => {
  ...
  return (
    ...
    >
      <div className="p-1">
        ...
        <button className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors text-left">
          <Icon icon="mingcute:file-download-line" width="18" />
          Download Invoice
        </button>
