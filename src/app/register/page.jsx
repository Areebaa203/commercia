      ...
      <div className="hidden w-1/2 flex-col justify-between bg-blue-600 p-12 text-white lg:flex relative overflow-hidden">
        ...
        <div className="z-10 max-w-md space-y-6">
          ...
          <p className="text-lg text-blue-100">
            Create an account to start managing your store and accessing exclusive features.
          </p>
        </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          {!successMsg && (
            ...
            <div className="relative flex items-center justify-center">
              ...
              <div className="relative bg-white px-4 text-sm text-gray-400">Or sign up with email</div>
            </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600"
                  >
                    <Icon icon={showConfirm ? "mingcute:eye-line" : "mingcute:eye-close-line"} className="text-lg" />
                  </button>
                </div>
